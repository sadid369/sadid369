...
[![Stack Overflow](https://img.shields.io/badge/Stack_Overflow-FE7A16?style=for-the-badge&logo=stack-overflow&logoColor=white)](https://stackoverflow.com/users/17400099/sadid369)
...
I'm a **Flutter Developer & Mobile Architect** based in 🇧🇩 **Bangladesh**, focused on building high-quality cross-platform mobile experiences. I care about clean code, scalable architecture, and interfaces that feel effortless to use.

```
🔭  Building a Fantasy Sports Platform with real-time WebSocket updates
🏗️  Practicing Clean Architecture with GetX, Riverpod & BLoC
🌱  Exploring AI/ML integration in mobile apps, Flutter Web & Desktop
💬  Ask me about Flutter, Dart, state management & app architecture
📫  sadid.dev
```
...
<img src="https://github-readme-stats.vercel.app/api?username=sadid369&show_icons=true&theme=tokyonight&hide_border=true&count_private=true&bg_color=0D1117&title_color=58A6FF&text_color=8b949e&icon_color=FF7B72" width="100%"/>
...
![BLoC](https://img.shields.io/badge/BLoC-00BCD4?style=for-the-badge&logoColor=white)
...
Real-time fantasy sports app built with **Clean Architecture**, **GetX + Riverpod**, and **WebSocket**-powered live scoring. Features an animated custom bottom nav bar and a unified, parameterized home screen system.

`Flutter` `GetX` `Riverpod` `GoRouter` `WebSocket`

</td>
<td width="50%" valign="top">

### 🎮 Stack Rush
An arcade-style game built on the **Flame** engine with Firebase backing and GetX state management — architected end-to-end from Firestore schema to gameplay components.

`Flutter` `Flame` `Firebase` `GetX`
