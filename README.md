...
- 🔭 Currently building **fantasy sports platforms** with real-time WebSocket updates
...
| 🏗️ **Architecture** | Implemented Clean Architecture across large-scale Flutter projects |
| 🔄 **Real-time Systems** | Built WebSocket-powered live-update systems for fantasy sports |
| 📦 **Open Source** | Active contributor with public Flutter packages & utilities |
| 🧩 **State Management** | Proficient across GetX · Riverpod · BLoC · Provider |
| ✍️ **Technical Writing** | Published articles on Dev.to & Medium covering Flutter best practices |
